...
type ButtonVariant = 'primary' | 'secondary' | 'ghost' | 'destructive' | 'outline' | 'glass';
...
const variantStyles: Record<ButtonVariant, string> = {
  ...
  glass:
    'glass hover:bg-[var(--color-bg-hover)] text-[var(--color-text-primary)] transition-all duration-[var(--duration-fast)] active:opacity-90',
};
  ...
  (
    ...
    return (
      <Comp
        ...
        aria-busy={loading}
        className={[
          'inline-flex items-center justify-center font-semibold rounded-[var(--radius-button)] whitespace-nowrap shrink-0',
          'transition-all duration-[var(--duration-fast)] select-none active-scale',
