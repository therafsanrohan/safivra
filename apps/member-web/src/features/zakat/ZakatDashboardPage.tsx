  ...
  return (
    <div className="space-y-6 pb-12 p-4 md:p-8 bg-[var(--color-bg-page)] min-h-svh max-w-5xl mx-auto">
      <div className="flex items-center gap-3 mb-2">
         ...
         <h1 className="text-2xl md:text-3xl font-bold tracking-tight text-[var(--color-text-primary)]">Zakat Intelligence</h1>
      </div>
        ...
        <div className="bg-gradient-to-br from-emerald-500 to-emerald-700 dark:from-emerald-800 dark:to-emerald-950 rounded-[2rem] p-6 md:p-10 text-white shadow-xl shadow-emerald-600/20 dark:shadow-none relative overflow-hidden border border-emerald-400/30 dark:border-emerald-500/20">
          ...
          <div className="relative z-10 flex flex-col md:flex-row gap-8 items-center justify-between">
            <div className="space-y-3 text-center md:text-left w-full md:w-auto flex-1">
              <h2 className="text-3xl md:text-4xl font-bold tracking-tight text-white drop-shadow-sm">Calculate Your Zakat</h2>
        ...
        <section className="space-y-5 pt-4">
          <div className="flex items-center justify-between px-2">
            <h3 className="text-xl font-bold tracking-tight text-[var(--color-text-primary)]">Current Nisab & Rates</h3>
            <button 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-6">
            ...
            <div className="p-6 md:p-8 border border-emerald-100/80 bg-gradient-to-br from-emerald-50/50 to-white dark:from-emerald-950/20 dark:to-black/20 dark:border-emerald-900/50 rounded-[2rem] shadow-sm relative overflow-hidden transition-all hover:shadow-md">
              <div className="flex items-start justify-between mb-6">
                ...
                <div className="text-right">
                  <span className="text-[10px] font-bold uppercase tracking-widest text-emerald-600/70 dark:text-emerald-400/70">Active Standard</span>
                  <div className="inline-flex items-center mt-1 px-3 py-1 bg-emerald-100 dark:bg-emerald-900/40 rounded-full">
                    <p className="text-xs font-semibold text-emerald-700 dark:text-emerald-300 capitalize">{activeRules?.nisab_standard || 'Unknown'}</p>
                  </div>
                </div>
              </div>
              
              <p className="text-sm font-medium text-[var(--color-text-secondary)] mb-2">Current Nisab Threshold</p>
            ...
            <div className="p-6 md:p-8 rounded-[2rem] bg-white dark:bg-[var(--color-bg-elevated)] border border-[var(--color-border)] shadow-sm flex flex-col justify-between hover:shadow-md transition-all">
              <div className="space-y-5">
                <h3 className="text-sm font-bold uppercase tracking-widest text-[var(--color-text-muted)] mb-2">Market Rates</h3>
                ...
                <div className="flex justify-between items-center p-4 bg-yellow-50/50 dark:bg-yellow-950/10 border border-yellow-100 dark:border-yellow-900/30 rounded-2xl">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-[var(--color-text-secondary)] font-medium">Gold (per gram)</span>
                  </div>
                ...
                <div className="flex justify-between items-center p-4 bg-slate-50 dark:bg-slate-900/30 border border-slate-100 dark:border-slate-800 rounded-2xl">
                  <div className="flex items-center gap-3">
                     ...
                     <span className="text-[var(--color-text-secondary)] font-medium">Silver (per gram)</span>
                  </div>
                  <span className="font-bold text-[var(--color-text-primary)] text-lg">
              ...
              <div className="mt-6 pt-5 border-t border-[var(--color-border)] flex flex-wrap items-center justify-between gap-2 text-xs font-medium text-[var(--color-text-tertiary)]">
                <span className="flex items-center bg-[var(--color-bg-subtle)] px-2.5 py-1 rounded-md">
                  Source: <span className="ml-1 text-[var(--color-text-secondary)]">{activeRate?.provider_name || '---'}</span>
                </span>
                <span className="flex items-center bg-[var(--color-bg-subtle)] px-2.5 py-1 rounded-md">
