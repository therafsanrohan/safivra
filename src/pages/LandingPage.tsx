                ...
                <div className="space-y-6 animate-in fade-in duration-300">
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <div className="p-4 rounded-xl bg-[var(--color-bg-surface)] border border-[var(--color-border)] shadow-sm">
                      ...
                      <p className="text-2xl sm:text-3xl font-bold text-[var(--color-text-primary)] mt-1">৳৪,৮৫,২৫০</p>
                      <span className="text-xs text-emerald-600 font-medium mt-1 inline-block">↑ +১২.৪% {isBn ? 'এই মাসে বৃদ্ধি' : 'this month'}</span>
                    </div>
                    <div className="p-4 rounded-xl bg-[var(--color-bg-surface)] border border-[var(--color-border)] shadow-sm">
                      <span className="text-xs font-medium text-[var(--color-text-muted)] uppercase tracking-wider">{isBn ? 'মোট আয়' : 'Monthly Income'}</span>
                      <p className="text-2xl sm:text-3xl font-bold text-emerald-600 mt-1">৳১,২০,০০০</p>
                    ...
                    <div className="p-4 rounded-xl bg-[var(--color-bg-surface)] border border-[var(--color-border)] shadow-sm">
                      ...
                      <p className="text-2xl sm:text-3xl font-bold text-rose-600 mt-1">৳৫২,৪০০</p>
                      <span className="text-xs text-[var(--color-text-muted)] mt-1 inline-block">{isBn ? 'বাজেটের ৬৮%' : '68% of Budget'}</span>
                    </div>
                  </div>
                    ...
                    <div className="p-5 rounded-xl bg-[var(--color-bg-surface)] border border-[var(--color-border)]">
                      ...
                      <div className="space-y-2.5">
                        <div className="flex justify-between items-center text-sm py-1.5 border-b border-[var(--color-border)]">
                          ...
                          <span className="font-semibold text-emerald-600">৳২,৪৫,০০০</span>
                        </div>
                        <div className="flex justify-between items-center text-sm py-1.5 border-b border-[var(--color-border)]">
                          <span className="font-medium text-[var(--color-text-primary)]">bKash Personal Wallet</span>
                          <span className="font-semibold text-emerald-600">৳১৮,৫০০</span>
                        </div>
                        <div className="flex justify-between items-center text-sm py-1.5">
                          <span className="font-medium text-[var(--color-text-primary)]">BRAC Bank Savings</span>
                          <span className="font-semibold text-emerald-600">৳২,২১,৭৫০</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="p-5 rounded-xl bg-[var(--color-bg-surface)] border border-[var(--color-border)]">
                      ...
                      <div className="space-y-2.5">
                        <div className="flex justify-between items-center text-sm py-1.5 border-b border-[var(--color-border)]">
                          ...
                          <span className="font-semibold text-rose-600">-৳৪,২০০</span>
                        </div>
                        <div className="flex justify-between items-center text-sm py-1.5">
                          <div>
                          ...
                          <span className="font-semibold text-emerald-600">+৳১,২০,০০০</span>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="p-5 rounded-xl bg-gradient-to-br from-slate-900 to-slate-800 text-white shadow-lg space-y-4">
                      ...
                      <div>
                        ...
                        <p className="text-3xl font-bold text-rose-400 mt-0.5">৳২৮,৫০০</p>
                      </div>
                      <div className="flex justify-between items-center text-xs text-slate-300 pt-2 border-t border-slate-700/60">
                        <span>{isBn ? 'লিমিট: ৳১,৫০,০০০' : 'Limit: ৳1,50,000'}</span>
                        <span>{isBn ? 'ডিউ ডেট: ১৫ই প্রতি মাস' : 'Due: 15th monthly'}</span>
                      </div>
                    </div>
                    ...
                    <div className="p-5 rounded-xl bg-[var(--color-bg-surface)] border border-[var(--color-border)] flex flex-col justify-center space-y-3">
                      ...
                      <div className="flex justify-between items-end">
                        <span className="text-2xl font-bold text-[var(--color-text-primary)]">১৯.০%</span>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="p-5 rounded-xl bg-[var(--color-bg-surface)] border border-[var(--color-border)] space-y-3">
                      ...
                      <div>
                        ...
                        <p className="text-3xl font-bold text-rose-600 mt-0.5">৳৪৫,০০০</p>
                        <span className="text-xs text-[var(--color-text-muted)]">{isBn ? 'মূল ঋণ: ৳১,০০,০০০' : 'Original: ৳1,00,000'}</span>
                      </div>
                      <div className="w-full bg-[var(--color-border)] h-2 rounded-full overflow-hidden">
                        <div className="bg-emerald-500 h-full w-[55%]" />
                      </div>
                      <p className="text-xs text-emerald-600 font-medium">৫৫% {isBn ? 'পরিশোধ সম্পন্ন' : 'Principal Repaid'}</p>
                    </div>
                    ...
                    <div className="p-5 rounded-xl bg-[var(--color-bg-surface)] border border-[var(--color-border)] flex flex-col justify-center space-y-3">
                      ...
                      <p className="text-3xl font-bold text-[var(--color-text-primary)]">৳৫,২৫০</p>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="p-5 rounded-xl bg-[var(--color-bg-surface)] border border-[var(--color-border)] space-y-3">
                      ...
                      <div>
                        ...
                        <p className="text-3xl font-bold text-emerald-600 mt-0.5">৳১,৮০,০০০</p>
                      </div>
                      <p className="text-xs text-[var(--color-text-muted)]">{isBn ? 'মাসিক কিস্তি: ৳৫,০০০ · সুদের হার: ৮.৫%' : 'Monthly: ৳5,000 · Rate: 8.5%'}</p>
                    </div>
                    ...
                    <div className="p-5 rounded-xl bg-[var(--color-bg-surface)] border border-[var(--color-border)] flex flex-col justify-center space-y-3">
                      ...
                      <p className="text-3xl font-bold text-[var(--color-text-primary)]">৳৩,৬৪,০০০</p>
                      <p className="text-xs text-emerald-600 font-medium">৳৬৪,০০০ {isBn ? 'মুনাফা বা লাভ' : 'Estimated Return'}</p>
                    </div>
                  </div>
                </div>
              )}
