  ...
  const loadDashboard = useCallback(async () => {
    ...
    try {
      ...
      const sampleCashflow = [
        { label: 'Feb', income: 160000, expense: 58000 },
        { label: 'Mar', income: 175000, expense: 62000 },
        { label: 'Apr', income: 165000, expense: 71000 },
        { label: 'May', income: 180000, expense: 59000 },
        { label: 'Jun', income: 185000, expense: 61500 },
        { label: 'Jul', income: 185000, expense: 64200 },
      ];

      const sampleUpcoming: UpcomingPayment[] = [
        {
          id: 'pmt-1',
          title: 'DBBL Home Loan EMI',
          amount: 22500,
      ...
      const sampleTx: RecentTransaction[] = [
        {
          id: 'tx-1',
      ...
      setData({
        ...
        cashflowHistory: sampleCashflow,
        loanOutstanding: 120000,
        creditOutstanding: 34200,
        upcomingPayments: sampleUpcoming,
        recentTransactions: sampleTx,
      });
    } finally {
      setLoading(false);
    }
